...
namespace Assets.Scripts
{
    class Slicer
    {
        ...
        {            
            ...
            positiveObject.GetComponent<SkinnedMeshRenderer>().bones = root.GetComponentsInChildren<Transform>();
            GameObject root2 = GameObject.CreatePrimitive(PrimitiveType.Sphere);
            root2.transform.localScale = new Vector3(0.1f, 0.1f, 0.1f);
            root2.transform.position = positiveObject.GetComponent<SkinnedMeshRenderer>().bones[5].transform.position;
